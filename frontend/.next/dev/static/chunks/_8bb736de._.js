...
function HomePage() {
    ...
    const fetchTodos = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "HomePage.useCallback[fetchTodos]": async ()=>{
            ...
            setError("");
            try {
                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTodos"])({
    ...
    async function handleAdd() {
        ...
        setError("");
        try {
            const todo = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createTodo"])(title);
            setInputText("");
    ...
    async function handleMarkDone(id) {
        try {
            const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["markDone"])(id);
    ...
    async function handleRestore(id) {
        try {
            const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["restoreTodo"])(id);
            setTodos((prev)=>filter === "all" ? prev.map((t)=>t.id === id ? updated : t) : prev.filter((t)=>t.id !== id));
        } catch (e) {
            setError(e.message);
        }
    ...
    async function handleDelete(id) {
        try {
            const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteTodo"])(id);
            setTodos((prev)=>filter === "all" ? prev.map((t)=>t.id === id ? updated : t) : prev.filter((t)=>t.id !== id));
        } catch (e) {
            setError(e.message);
        }
    ...
    async function handleEditSave(id) {
        ...
        if (!title) return;
        try {
            const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateTodo"])(id, {
                title
            });
...
//# sourceMappingURL=_8bb736de._.js.map